        ...
        messages = [
            {
                ...
                "content": [
                    {"type": "text", "text":
                        ...
                        "as well as the extracted text from the image delimited by three backticks.\n"
                        "Example output for hateful meme : hateful - explanation in 30 words that why the meme is hateful.\n"
        ...
        if selected_images:
            for i in range(len(selected_images[0])):
                ...
                messages.append({
                    "role": "assistant",
                    "content": [
                        {"type": "text", "text": f"{dictionary[selected_images[0][i]['label']]} - {interpretation_img}"}
                    ],
                })
...
if __name__ == "__main__":
    ...
    for embedding in [EMBEDDINGS[0], EMBEDDINGS[1], EMBEDDINGS[2]]:
        ...
        for shot in [2, 4, 8]:
            ...
            perform_inference.generate_output(
                output_directory="/home/subhankar-am/nrizwan/experiments/",
            ...
            email_classification_report('/home/subhankar-am/nrizwan/experiments/', f"{file_name}_0.txt", "subhankar.official185@gmail.com")
