...
login(token="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")
...
# fhm_exp_file_path = '/home/rizwan-am/nrizwan/fhm-explanation/Annotation of Explanation (test) - FHM-train-not-hateful.csv'
        ...
        if selected_images:
            for i in range(len(selected_images[0])):
                ...
                messages.append({
                    "role": "assistant",
                    "content": [
                        {"type": "text", "text": f"{dictionary[selected_images[0][i]['label']]} - {interpretation_img}{intervene}"}
                    ],
                })
...
for embedding in [EMBEDDINGS[2]]:
    ...
    for shot in [8, 4, 2]:
        file_name = f"internvl_RICES_{embedding}_{shot}_shots_MAMI_test"
        ...
        # email_classification_report('/home/rizwan-am/nrizwan/qwen_explanation_intervention/', f"{file_name}_0.txt", "naqueerizwan1998@gmail.com")
